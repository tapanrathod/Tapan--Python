...
# 🔹 Attributes:
# account_holder
# balance (initial balance should be given while creating object)
# transactions (store history of operations)
...
# ❌ Do NOT allow withdrawal if:
# amount ≤ 0
# balance is insufficient
# Maintain minimum balance ₹1000
# check_balance()
# Display current balance
# show_transactions()
# Show all deposits and withdrawals
...
# add transection history in above code and show it when user ask for it.
