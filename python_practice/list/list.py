...
# a.pop(2) # will delete specific value from the list (index number must in the brackets) (index number required)
# print(a)

# b = a.pop(2) # will copy whole list in b then remove value which is specific index metioned in brackets and then print which value is removed
# print(a)
# print(b)
...
# s.short() # list sort in ascending order (by default)
# print(a)
...
# index :
# print(a.index("ajay", 2,3 )) # to find index of specific values


# count :
# print(a.count("ajay")) # count values
...
# print("4 :", a[3:100]) # it will print the list from the specified index to the end if mentiond index is out of range
# print("5 :", a[8:3]) # will print empty list because mentioned index numbers are inverse
# print("6 :", a[-1], a[-5]) # will print values of mentioned index numbers but in reverse (no colons)
# print("7 :", a[-5:]) # will print reverse values of specified index number (with colons)
# print("8 :", a[0:8:3]) # will skip 3 index numbers
# print("9 :", a[8:0:-1]) # will print inverse list (minus sign is required)
# print("10 :", a[-1:-5:-1]) # will print inverse list with skipped values (both side minus signs are required)
# print("11 :", a[::-1]) # will print complete inverse list because no index number is mentioned in the begining
...
# a = [i**2 for i in range(1, 11)] # operations in list like +, -, *, /, **, etc. (list is already formed, see square brackets)

# print(a)

# nested list or 2D list : # lists in list

# a = [[1, 2, 3], [4, 5, 6], [7, 8, 9]] # lists in list
...
# n = int(input("How many values ? :")) # will add only integer values in the list because of "int" mentioned # if there is mentioned nothing then it will take any values in thr list
